...
namespace StudentTD {
    class GameWorld {
        ...
        /// </summary> 
        private static List<GameObject> objects;                            // Current game objects
        private static List<GameObject> newObjects;                         // Used to Add new objects
        private static List<GameObject> removeObjects;                      // Used to Remove objects
        ...
        /// </summary> 
        private static GameObject towerToPlace;                             // Used to keep a single tower at cursor while placing it
        ...
        public static List<GameObject> NewObjects {
            get { return GameWorld.newObjects; }
            set { GameWorld.newObjects = value; }
        }
        public static List<GameObject> RemoveObjects {
            get { return GameWorld.removeObjects; }
            set { GameWorld.removeObjects = value; }
        }
        public static GameObject TowerToPlace {
            get { return GameWorld.towerToPlace; }
            set { GameWorld.towerToPlace = value; }
        }
        public static Wave WaveKeeper {
            get { return GameWorld.waveKeeper; }
            set { GameWorld.waveKeeper = value; }
        }
        ...
        public static int LifeCounter {
            get { return GameWorld.lifeCounter; }
            set { GameWorld.lifeCounter = value; }
        }
        public static int Currency {
            get { return GameWorld.currency; }
            set { GameWorld.currency = value; }
        }
        ...
        public void SetupWorld() {
            ...
            objects.Add(new AirTower(@"sprites\towers\airtower.png", new PointF(672f, 104f), 0, 1, 1, false, false, false));
        ...
        private void Draw() {
            ...
            dc.DrawLines(p, GameWorld.Checkpoints);
